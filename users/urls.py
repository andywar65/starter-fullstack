...
urlpatterns = [
    ...
    path('contact/', ContactFormView.as_view(), name='account_contact'),
    ...
    path('password/change/', TestedPasswordChangeView.as_view(),
        name='password_change'),
    path('password/set/', TestedPasswordSetView.as_view(), name='password_set'),
    path('password/reset/', TestedPasswordResetView.as_view(),
        name='password_reset'),
