    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('temp_image', models.ImageField(blank=True, max_length=200, null=True, upload_to='uploads/images/users/', verbose_name='Image')),
                ...
                ('bio_it', models.TextField(blank=True, null=True, verbose_name='Short bio')),
                ('bio_en', models.TextField(blank=True, null=True, verbose_name='Short bio')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_message', to=settings.AUTH_USER_MODEL, verbose_name='User')),
            ],
            options={
